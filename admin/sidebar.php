                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <!-- <a class="nav-link" href="index.php">
                                ...
                                <small>My Access Code(<?php echo"$level_code"; ?>)</small>
                            </a> -->
                            <div class="sb-sidenav-menu-heading text-white">Admin Dashboard</div>
						  ...
						  <a class="nav-link collapsed text-white"" href="#" data-toggle="collapse" data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link text-white"" href="view_admin.php">View Admin</a> 
